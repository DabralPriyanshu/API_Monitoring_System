//we will write global configurations here
...
const config = {
    ...
    postgres: {
        ...
        password: process.env.PG_PASSWORD || 'priyanshu',
    },
    ...
    // Rate Limit
    rateLimit: {
        windowMs: parseInt(process.env.RATE_LIMIT_WINDOW_MS || '900000', 10), // 15 minutes window size only 1000 req in this window 
